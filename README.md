...
24GB VRAM Local Cmd: `docker container run -it --gpus device=0 -p 8188:8188 camenduru/wan-2-1-i2v-comfyui:fp8` <br />
64GB VRAM Local Cmd: `docker container run -it --gpus device=0 -p 8188:8188 camenduru/wan-2-1-i2v-comfyui:fp16` <br />
